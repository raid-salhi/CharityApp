...
import com.example.adminpanel.classes.ViewPagerDetailsAdapter
import com.example.adminpanel.databinding.FragmentDeatilsBinding
...
class DeatilsFragment : Fragment() {
    ...
    private var _binding: FragmentDeatilsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDeatilsBinding.inflate(inflater, container, false)
...
//        }
        ...
        deleteButton.setOnClickListener {
            db.collection(param2!!).document(param9!!)
                .delete()
                .addOnSuccessListener {
                    findNavController().navigate(R.id.navigation_project)
                    Toast.makeText(
                        requireContext(),
    ...
    private fun setFragmentsToViewPager(adapter: ViewPagerDetailsAdapter) {
        if (param7!! >= 1) {
            ...
            adapter.addFragment(PictureFragment(), "Pictures")
        } else
            adapter.addFragment(DescriptionFragment(), "Description")
