...
import com.example.adminpanel.classes.SliderImageAdapter
import com.example.adminpanel.databinding.FragmentPicturesBinding
...
class PictureFragment : Fragment() {
    ...
    companion object {
        fun newInstance(params1: String,
                        params2: String,
                        params3: Int) = PictureFragment().apply {
